  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-3 sm:px-4 py-6" style={{ background: "#F7F6F3" }}>
      ...
      <div className="w-full max-w-[400px] bg-white rounded-xl sm:rounded-2xl border border-[#D0D0E0] px-5 py-6 sm:p-8 shadow-sm">
        <h1 className="text-[20px] sm:text-[24px] text-[#1A1916] mb-1" style={{ fontWeight: 700 }}>Welcome back</h1>
        <p className="text-[12px] sm:text-[13px] text-[#8C8980] mb-5 sm:mb-6">Sign in to continue analyzing your meetings</p>
        ...
        <div className="mb-3 sm:mb-4">
          ...
          <input
            ...
            className="w-full bg-white border rounded-md px-3 py-2 text-[13px] text-[#1A1916] placeholder-[#B8B5AE] outline-none transition-all"
        ...
        <div className="mb-3 sm:mb-4">
          <div className="flex items-center justify-between mb-1.5">
            <label className="text-[12px] text-[#504E49]" style={{ fontWeight: 500 }}>Password</label>
            <button onClick={() => navigate("/forgot-password")} className="text-[11px] text-[#6366F1] hover:text-[#818CF8] transition-colors">
              Forgot password?
            </button>
          </div>
          <div className="relative">
            <input
              ...
              className="w-full bg-white border rounded-md px-3 py-2 pr-9 text-[13px] text-[#1A1916] placeholder-[#B8B5AE] outline-none transition-all"
              style={{ borderColor: errors.password ? "#F43F5E" : "#D0D0E0" }}
            />
            <button onClick={() => setShowPassword(!showPassword)} className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[#8C8980] hover:text-[#504E49]">
        ...
        <div className="flex items-center gap-3 my-4 sm:my-5">
          <div className="flex-1 h-px bg-[#D9D6D0]" />
          <span className="text-[11px] text-[#8C8980]">or continue with</span>
          <div className="flex-1 h-px bg-[#D9D6D0]" />
        </div>

        {/* OAuth */}
        <div className="flex flex-col xs:flex-row gap-2 sm:gap-3">
          <button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-md border border-[#D0D0E0] text-[12px] text-[#1A1916] hover:bg-[#F7F6F3] transition-colors" style={{ fontWeight: 500 }}>
          ...
          <button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-md border border-[#D0D0E0] text-[12px] text-[#1A1916] hover:bg-[#F7F6F3] transition-colors" style={{ fontWeight: 500 }}>
            <svg viewBox="0 0 24 24" width="16" height="16" fill="#1A1916">
        ...
        <p className="text-center text-[11px] sm:text-[12px] text-[#8C8980] mt-4 sm:mt-5">
          ...
          <button onClick={() => navigate("/register")} className="text-[#6366F1] hover:text-[#818CF8] transition-colors" style={{ fontWeight: 500 }}>
            Register
          </button>
        </p>
      </div>
